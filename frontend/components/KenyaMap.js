...
import { RegionIcon, TopicIcon, TypeIcon } from './Icons';
...
export default function KenyaMap({
  ...
  const projectCounties =
    regions.length > 0
      ? regions.map((r) => r.name).filter((name) => name !== 'Other')
      : [
          'Marsabit',
          'Taita Taveta',
          'Turkana',
  ...
  const countyData = {
    Marsabit: {
      population: '459,785',
      area: '66,923',
      languages: 'Cushitic, Nilotic',
      valueChains: ['Fish', 'Agriculture', 'Livestock'],
      description:
        'Marsabit County is a county in Kenya, covering a surface area of 66,923.1 square kilometres.',
      opportunities: [
        {
          title: 'Livestock Value Chain',
          sector: 'Agriculture',
          description: 'Investment in modern livestock management systems',
        },
        {
          title: 'Sustainable Pastoralism',
          sector: 'Agriculture',
          description:
            'Supporting pastoral communities with sustainable practices',
        },
      ],
    },
  };
  ...
  return (
    <div className="flex gap-6 p-6 bg-gray-10 min-h-screen w-full">
      ...
      <div className="space-y-4 w-[450px]">
        {showCountyDetails && selectedCounty && countyData[selectedCounty] && (
          <div className="bg-white rounded-xl shadow-lg p-6 animate-fade-in">
            ...
            <p className="text-gray-600 mb-4">
              {countyData[selectedCounty].description}
            </p>
            ...
            <div className="space-y-3 mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {countyData[selectedCounty].population}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {countyData[selectedCounty].area} km²
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {countyData[selectedCounty].languages}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-4">
              <h4 className="font-semibold text-gray-800 mb-2">Value Chains</h4>
              <div className="flex flex-wrap gap-2">
                {countyData[selectedCounty].valueChains.map((chain, idx) => (
                  <span
                    key={idx}
        ...
        {selectedCounty && countyData[selectedCounty] && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">
              Investment Opportunities in {selectedCounty}
            </h3>

            <div className="space-y-3">
              {countyData[selectedCounty].opportunities.map((opp, idx) => (
                <div
                  key={idx}
        ...
        {!selectedCounty && (
          <>
            <div className="rounded-xl p-6 border border-gray-200 shadow-lg bg-white">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <p className="text-gray-600 text-sm mb-4">
            Download our comprehensive guide on social accountability practices
          </p>
