...
const headingStyles = {
  h1: {
    ...
    bold: 'text-5xl md:text-6xl font-assistant font-bold',
  ...
  h2: {
    ...
    bold: 'text-4xl md:text-5xl font-assistant font-bold',
  ...
  h3: {
    ...
    bold: 'text-3xl md:text-4xl font-assistant font-bold',
  ...
  h4: {
    ...
    bold: 'text-2xl md:text-3xl font-assistant font-bold',
  ...
  h5: {
    ...
    bold: 'text-xl md:text-2xl font-assistant font-bold',
